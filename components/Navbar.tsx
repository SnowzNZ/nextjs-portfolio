        ...
        <div>
          <div className="flex items-center justify-between py-3 md:py-5 md:block">
            <div className="container flex items-center space-x-2">
              <h2 className="text-2xl font-bold">Snowz</h2>
            </div>
              ...
              {NAV_ITEMS.map((item, idx) => {
                return (
                  <Link
                    ...
                    to={item.page}
                    className={
                      "block lg:inline-block text-neutral-900  hover:text-neutral-500 cursor-pointer dark:text-neutral-100 hover:underline"
                    }
                    activeClass="active"
                    spy={true}
                    smooth={true}
